        ...
        implements ParquetMetadataSource
{
            ...
            throws IOException
    {
        try {
            if (cacheable) {
                return cache.get(parquetDataSourceId, () -> delegate.getParquetMetadata(inputStream, parquetDataSourceId, fileSize, cacheable, fileDecryptionProperties, fileDecryptor));
            }
            return delegate.getParquetMetadata(inputStream, parquetDataSourceId, fileSize, cacheable, fileDecryptionProperties, fileDecryptor);
        }
